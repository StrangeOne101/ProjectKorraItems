...
import com.projectkorra.items.attribute.AttributePrefix.AttributePriority;
...
public class AttributeBuilder {
	...
	public static void setupSuffixes() {
		if (!suffixes.isEmpty()) return;
		List<String> defaultAttributes = new ArrayList<String>();
		
		defaultAttributes.addAll(Arrays.asList(basicSuffixes));

		for (String s : defaultAttributes) {
